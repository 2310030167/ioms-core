...
              {[{ t: "Pipeline", v: ld ? "..." : st.pipeline }, { t: "Active Tasks", v: ld ? "..." : st.tasks }, { t: "Clearance Level", v: ld ? "..." : rl.toUpperCase() }].map((c, i) => (
...
                  <div className="flex items-center justify-between border-b border-[#231C30]/40 pb-3 mb-4"><h3 className="text-xs font-bold text-white uppercase">Workload</h3><div className="text-emerald-400 font-mono text-[10px]">LIVE SYNC OK</div></div>
